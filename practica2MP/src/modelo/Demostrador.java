...
public class Demostrador {
    ...
    public static void main(String[] args) {
        ...
        EntradaGenerica entrada = creacionEntrada(subforo);
    ...
    private static Comentario comentarEntrada(EntradaGenerica entrada){
        Comentario comentario = null;
        System.out.println("Se comentará la entrada si está visible.");
        if (entrada != null && entrada.getVerificada()){
            comentario = ((Entrada)entrada).comentar("TextoComentario");
    ...
    private static void votarEntrada(EntradaGenerica entrada){
    ...
    private static void altaSubforo(Subforo subforo){
        ...
        if (subforo != null && subforo.anadirSubscriptor(sistema.getUsuarioConectado())){
    ...
    private static void bajaSubforo(Subforo subforo){
        ...
        if (subforo != null && subforo.eliminarSubscriptor(sistema.getUsuarioConectado())){
